...
```{r soc-barrio, echo=FALSE, fig.align='center', fig.cap='9.1 Sociabilidad Barrial, según ola de estudio'}
...
```{r soc-barrio-alta, echo=FALSE, fig.align='center', fig.cap='ambios en Sociabilidad Barrial, según ola de estudio. Porcentaje con sociabilidad barrial "Alta".'}
...
```{r soc-alta-zona, echo=FALSE, fig.align='center', fig.cap='Porcentaje de Sociabilidad Barrial "Alta", según ola de estudio y zona geográfica'}
...
```{r soc-barrio-resi, echo=FALSE, fig.align='center', fig.cap='Porcentaje de Sociabilidad Barrial "Alta", según ola de estudio y zona de residencia'}
...
```{r soc-alta-resid, echo=FALSE, fig.align='center', fig.cap='Porcentaje de Sociabilidad Barrial "Alta", según ola de estudio y zona de residencia"'}
...
```{r socalta-quintil, echo=FALSE, fig.align='center', fig.cap='Porcentaje con Índice de Sociabilidad Barrial "Alta", según ola de estudio y quintil de ingresos del hogar'}
