...
```{r echo=FALSE, fig.align='center',fig.cap='Sociabilidad Barrial, según ola de estudio'}
...
```{r echo=FALSE, fig.align='center',fig.cap='Cambios en Sociabilidad Barrial, según ola de estudio. Porcentaje con sociabilidad barrial "Alta".'}
...
```{r echo=FALSE, fig.align='center',fig.cap='Porcentaje de Sociabilidad Barrial "Alta", según ola de estudio y zona geográfica'}
...
```{r echo=FALSE, fig.align='center',fig.cap='Porcentaje de Sociabilidad Barrial "Alta", según ola de estudio y zona de residencia'}
...
```{r echo=FALSE, fig.align='center',fig.cap='Porcentaje con Índice de Sociabilidad Barrial "Alta", según ola de estudio y quintil de ingresos del hogar'}
