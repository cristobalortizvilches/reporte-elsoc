...
save(gr.alluvial.freq.facet, ajustar_texto, gr.bar.media.list, gr.bar.freq, gr.bar.freq.rec, gr.bar.media, gr.line.freq, gr.line.freq.rec, gr.line.media, gr.alluvial.freq, tb.freq, tb.freq.rec, gr.bar.freq.list, gr.bar.freq.rec.list, gr.line.freq.rec.list, cortar_texto,
