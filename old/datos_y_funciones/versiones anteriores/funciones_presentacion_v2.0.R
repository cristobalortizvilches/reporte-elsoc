...
save(gr.bar.mediana, gr.alluvial.freq.facet, gr.bar.freq, gr.bar.freq.rec, gr.bar.media, gr.line.freq, gr.line.freq.rec, gr.line.media, gr.alluvial.freq, tb.freq, tb.freq.rec, gr.bar.freq.rec.list, gr.line.freq.rec.list, cortar_texto,
