...
elsoc_long$empleo <- factor(elsoc_long$empleo, 
                            labels = c("Trabajo remunerado", "Trabajo no remunerado", "Desempleo", "Jubilado/a o pensionado/a", "Otros"))
...
save(elsoc_long_2016_2019, elsoc_long, elsoc_panel, elsoc_panel_m1, elsoc_panel_m2, elsoc_wide_2016_2019, elsoc_wide, elsoc_wide_m1, elsoc_wide_m2,
     file = 'Presentacion/RCS2020/funciones_y_otros/datos_a_usar.RData')
