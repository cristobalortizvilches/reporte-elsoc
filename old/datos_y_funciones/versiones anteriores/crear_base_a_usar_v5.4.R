...
elsoc_long$empleo <- factor(elsoc_long$empleo, 
                            labels = c("Trabajo remunerado", "Desempleado", "Trabajo no remunerado", "Jubilado o pensionado", "Otros"))
...
save(elsoc_long_2016_2019, elsoc_panel, elsoc_panel_m1, elsoc_panel_m2, elsoc_wide_2016_2019, elsoc_wide, elsoc_wide_m1, elsoc_wide_m2,
