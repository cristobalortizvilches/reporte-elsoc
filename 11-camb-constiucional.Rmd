...
Porcentaje que responde "Frecuente" o "Muy frecuentemente" 
...
### 7.4 ¿En qué medida está usted de acuerdo o en desacuerdo con que se cambie la Constitución en Chile?, según tramo de edad
 Porcentaje que responde que está "De acuerdo" o "Muy de acuerdo" 
```{r echo=FALSE, fig.align='center'}
...
### 7.12 Desigualdad de voz política en la participación en el proceso constituyente
 ¿Ha participado en alguna instancia de discusión asociada al proceso de cambio de la Constitución?, según tramos de edad 
```{r echo=FALSE, fig.align='center'}
