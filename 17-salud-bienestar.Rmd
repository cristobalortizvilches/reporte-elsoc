...
```{r depre-sexo, echo=FALSE, fig.align='center',fig.cap='Cambios en Síntomas de depresión entre años 2016 y 2019, según sexo'}
...
```{r depre-edad-sexo,echo=FALSE, fig.align='center',fig.cap='Síntomas de Depresión según tramos de edad y sexo (2019). Porcentaje con síntomas de "Depresion Moderada" o "Depresion Moderada Severa a Severa".'}
...
```{r depre-labstat,echo=FALSE, fig.align='center',fig.cap='Síntomas de Depresión según categoría ocupacional (año 2019). Porcentaje con síntomas de "Depresion Moderada" o "Depresion Moderada Severa a Severa".'}
